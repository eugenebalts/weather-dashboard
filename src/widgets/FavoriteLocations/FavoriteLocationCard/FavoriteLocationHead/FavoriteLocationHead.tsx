...
const FavoriteLocationHead = ({ weather, fromGeolocation, initialCoordinates }: FavoriteLocationHeadProps) => {
  ...
  return (
    <div className={styles.wrapper}>
      <Location location={`${locationName} ${fromGeolocation ? '(My Location)' : ''}`} date={currentDate} />
      <div>
